                                    ...
                                    <div class="col-md-6 col-lg-4 mb-4">
                                        <div class="card shadow-sm border-0 h-100">
                                            <div class="card-body">
                                                @if ($jobPosting->count())
                                                    <h5>
                                                        {{ $jobPosting->first()->perusahaan->nama_perusahaan }}</h5>
                                                @endif

                                                <h5 class="card-title">{{ $item->judul }}</h5>
                                                <br>
                                                <p class="mb-1"><strong>Jenis:</strong>
                                                    {{ $item->jenisPekerjaan->jenis_pekerjaan }}</p>
                                                <p class="mb-1"><strong>Gaji:</strong> Rp
                                                    {{ number_format($item->rentang_gaji, 0, ',', '.') }}</p>
                                                ...
                                                <p class="mb-0">
                                                    ...
                                                    @if ($item->status == 1)
                                                        <span class="badge bg-success"><i
                                                                class="bi bi-check-circle-fill"></i> Diterima</span>
                                                    @elseif ($item->status == 2)
                                                        <span class="badge bg-danger"><i class="bi bi-x-circle-fill"></i>
                                                            Ditolak</span>
                                                    @else
                                                        <span class="badge bg-warning text-dark"><i
                                                                class="bi bi-clock-fill"></i> Menunggu</span>
                                                    @endif
                                                </p>
                                            </div>
                                        </div>
